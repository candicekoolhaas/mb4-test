...
#### EDIT BELOW IS NEW
### From mb1 index.qmd
### want to make similar forest plot but for mb4

Right now it can't find "lab" in the data and is crashing

```{r meta, include = FALSE}
project <- redivis::user("candice_koolhaas001")$project("test_mb4")
forest_table <- project$table("clean_data")$to_tibble()
